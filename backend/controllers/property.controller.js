  ...
  try {
    ...
    if (req.body.amenities) {
      if (Array.isArray(req.body.amenities)) {
        ...
        try {
          // If amenities comes as JSON string
    ...
    const property = await Property.create({
      ...
      // ==========================================
      // IMPORTANT:
      // imageUrls was undefined.
      // Correct variable is imageUrl.
      // ==========================================
      images: imageUrl,
...
export const getSellerDashboard = async (req, res) => {
  try {
    ...
    const totalInquires = await Inquiry.countDocuments({ seller: sellerId });

...
const ResetPassword = () => {
  ...
  const [showConfiramPassword, setShowConfiramPassword] = useState(false);
        ...
        <div className={s.formCard}>
          ...
          <form onSubmit={handleSubmit} className={s.form}>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  type={showConfiramPassword ? "text" : "password"}
                ...
                <button
                  type="button"
                  onClick={() => setShowConfiramPassword(!showConfiramPassword)}
                  style={{
                    position: "absolute",
                    right: "12px",
                    top: "50%",

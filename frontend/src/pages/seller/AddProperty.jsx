          ...
          <form onSubmit={handleSubmit} className={s.form}>
            ...
            <div className={s.section}>
              ...
              <div className={s.contentGroupLarge}>
                <div>
                  <label className={s.label}>Prooperty Title</label>
                  <input
                    type="text"
                    name="title"
                    value={formData.title}
                    onChange={handleInputChange}
                    placeholder="e.g. Laxury 3BHK Apartment in Downtown"
                    className={s.input}
                    required
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Describe the peroperty highlights..."
              ...
              <div>
                ...
                <div className={s.contentGroupSmall}>
                  ...
                  <div className={s.gridTwoCol}>
                    ...
                    <div>
                      <label className={s.labelSmallMargin}>Picode</label>
                      <input
                        type="text"
                        name="pincode"
            ...
            <div className={s.section}>
              ...
              <div className={s.amenitiesGrid}>
                {commonAmenities.map((ame) => (
                  <label
                    key={ame}
                    className={`${s.amenityLabelBase} 
                        ${
                          formData.amenities.includes(ame)
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={formData.amenities.includes(ame)}
                      onChange={() => handleAmenityChange(ame)}

...
const LandingPage = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (searchItem) params.append("city", searchItem);
      ...
      <section className={s.heroSection}>
        <div className={s.heroContent}>
          ...
          <p className={s.heroSubtitle}>
            ...
            verified listing, connect with top agents, and find a place you'll
            love.
          </p>
          ...
          <div className={s.statsContainer}>
            ...
            <div className={s.statItemBorder}>
              <h3 className={s.statNumber}>4.9/6</h3>
        ...
        <div className={s.container}>
          <div className={s.processHeader}>
            ...
            <h2 className={s.processTitle}>
              Our Semless <span className={s.textGradient}>Process</span>
            </h2>
      ...
      <section className={s.featuredSection}>
        <div className={s.container}>
          <div className={s.featuredHeader}>
            <span className={s.featuredBadge}>Handpicked For Yoy</span>
          ...
          <div className={s.footerMainGrid}>
            <div className={s.footerBrand}>
              ...
              <div className={s.socialIcons}>
                {[FaFacebook, FaTwitter, FaInstagram, FaLinkedinIn].map(
                  (Icon, idx) => (
          ...
          <div className={s.bottomBar}>
            <div className={s.bottomBarFlex}>
                ...
                <div className={s.footerLegalLinks}>
                    <a href="privacy-policy" className={s.footerLink}>
                        Privacy Policy
                    </a>
                    <a href="terms-services" className={s.footerLink}>
                        Terms of Service
                    </a>
                    <a href="cookies" className={s.footerLink}>
                        Cookies Settings
                    </a>
                </div>
            </div>
            ...
            <div className={s.designCredit}>
                ...
                <a href="https://chiranjeetportfolio.vercel.app/" target="_blank" className={s.designLink}>Chiranjeet Mourya</a>
            </div>
          </div>
        </div>
      </footer>

...
const ChatMessage = () => {
  ...
  // fetch the conversations (buyer and seller)
  useEffect(() => {
    const fetchConversations = async () => {
      try {
        ...
        const fetchedConversations =
          res.data.chats || res.data.conversations || res.data || [];
  ...
  //   update the chat new message received
  useEffect(() => {
    if (socket) {
  ...
  const handleDeleteChat = async (e, chatId) => {
    e.stopPropagation();
    if (!window.confirm("Are you sure you want to delete this conversations"))
      return;
                ...
                >
                  ...
                  <div className={s.conversationInfo}>
                    ...
                    <div className={s.conversationPreview}>
                      {chat.messages.at(-1)?.text || "Started a conversations"}
                    </div>
                  </div>

                  ...
                  <div className={s.actionWrapper}>
                    <div className={s.sellerInfo}>
                      <div className={s.sellerName}>
                        Seller: {pro.seller?.name || "Unknown"}
                      </div>
                      <div className={s.sellerEmail}>{pro.seller?.email}</div>
                    </div>

                    <div className={s.buttonGroup}>
                      <Link to={`/property/${pro._id}`} className={s.viewLink}>

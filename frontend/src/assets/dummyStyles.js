...
export const contactStyles = {
  ...
  mainContainer: "container py-16 px-6 max-w-[1200px] mx-auto",
...
export const landingPageStyles = {
  ...
  verifiedBadge:
    "glass absolute bottom-8 left-8 p-6 rounded-3xl flex items-center gap-4 max-w-[350px]",
...
export const loginStyles = {
  ...
  card: "glass fade-in w-full max-w-[500px] p-10 sm:p-6 rounded-3xl sm:rounded-2xl shadow-card",
  title: "text-[2rem] sm:text-2xl font-bold text-center mb-2 text-primary",
  subtitle: "text-center text-text-muted mb-8",

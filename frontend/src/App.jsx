...
import AdminInquires from "./pages/admin/AdminInquires";
...
import ChatMessage from "./pages/shared/ChatMessage";
import AdminSettings from "./pages/admin/AdminSettings";
import Contact from "./pages/shared/Contact";
import Wishlist from "./pages/buyer/Wishlist";
import PrivacyPolicy from "./pages/shared/PrivacyPolicy";
import TermsOfService from "./pages/shared/TermsOfService";
import CookiesSettings from "./pages/shared/CookiesSettings";
...
const ScrollTopBottom = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className={` fixed bottom-6 right-6 z-50 flex w-12 h-12 items-center justify-center
  ...
  return (
    <div className=" min-h-screen w-full overflow-x-hidden">
      ...
      <Routes>
        ...
        <Route
          element={
            <ProtectedRoute allowsRoles={["buyer", "seller", "admin"]} />
          }
        >
          ...
          <Route element={<ProtectedRoute allowsRoles={["seller"]} />}>
          ...
          <Route element={<ProtectedRoute allowsRoles={["admin"]} />}>
            <Route element={<AdminLayout />}>
              ...
              <Route path="/admin/inquiries" element={<AdminInquires />} />
